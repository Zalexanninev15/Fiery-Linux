...
echo 2
pkg install termux-am nala curl wget git micro openssl libqrencode zbar python3 ranger -y && echo "Press 'Allow' in the window that appears" && echo "or type 'Y' if you already have access" && "Process is underway to grant rights to the storage (Android)" && sleep 2
